...
const privacyContent = [
  {
    ...
    content: (
      <div className="space-y-6 mb-2">
        <p className="text-gray-600 leading-tight text-[14px]">
        ...
        <ul className="text-gray-600 leading-tight text-[14px]  list-inside space-y-2 mb-0">
  ...
  {
    id: "Change-to-this-statement",
    title: "Change to this statement",
    content: (
      <div className="space-y-6">
        <p className="text-gray-600 leading-tight text-[17px]">
          Under certain circumstances, the Company may be required to disclose your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
  ...
  return (
    <div className="min-h-screen bg-white text-white relative flex flex-col  ">
      ...
      <main className="flex-1 w-full max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24 relative z-10 flex flex-col">
        ...
        <div className="relative w-full mb-16 py-12 md:py-20 -mt-16 md:-mt-24">
          {/* Background Shape */}
          <div 
            className="absolute inset-0 bg-[#F9FAFB] -z-10"
            style={{ 
        ...
        <div className="flex flex-col md:flex-row gap-8 lg:gap-16 items-start flex-1 min-h-[500px]">
            ...
            <div className="flex flex-col gap-1 p-1">
              {privacyContent.map((tab) => (
                <button
                  ...
                  className={`relative text-left pl-10 pr-6 py-3.5 rounded-2xl text-[17px] font-medium transition-all whitespace-nowrap duration-300 ${activeTab === tab.id
                    ? "bg-white text-gray-900 shadow-[0_10px_25px_-5px_rgba(14,165,233,0.15)] ring-1 ring-sky-100/50 sticky top-0 z-10 before:content-[''] before:absolute before:left-4 before:top-1/2 before:-translate-y-1/2 before:w-[4px] before:h-6 before:bg-[#00A3FF] before:rounded-full"
          ...
          <div className="flex-1 w-full max-w-full md:max-w-[800px]  max-h-[1850px] md:max-h-[450px] relative overflow-hidden rounded-[32px] border border-[#00A3FF]/30 shadow-sm bg-white">

            {/* Content area */}
            <div className="relative z-10 p-8 pb-10 md:p-10 pr-6 h-[550px] mr-4 overflow-y-auto custom-scrollbar flex flex-col">
