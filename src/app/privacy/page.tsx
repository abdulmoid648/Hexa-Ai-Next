...
const privacyContent = [
  {
    ...
    content: (
      <div className="space-y-6">
        ...
        <ul className="text-gray-600 leading-relaxed text-[15px]  list-inside space-y-2 mb-0">
        ...
        <p className="text-gray-600 leading-relaxed text-[15px]">
          AI Voice & Communications Data. If you enable voice features or connect telephony, we may receive voice transcripts and call metadata necessary to process and refine the platform logic.
        </p>
      </div>
    ),
  },
  ...
  },
  {
    ...
    content: (
      <div className="space-y-6">
        ...
        <ul className="text-gray-600 leading-relaxed text-[17px] list-disc list-inside space-y-2">
      ...
      <main className="flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24 relative z-10 flex flex-col">
        ...
        <div className="flex flex-col md:flex-row gap-8 lg:gap-16 items-start flex-1 min-h-[500px]">
          ...
          <div className="flex-1 w-full max-w-6xl max-h-[1850px] md:max-h-[650px] relative">
            {/* Background container with blue-style border matching mockup */}
