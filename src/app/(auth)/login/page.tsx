...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (res.success) {
      router.push("/landing");
      // window.location.href = "https://gethexa.ai/";
    } else {
    ...
    <div className="relative flex items-center justify-center min-h-screen p-6 overflow-hidden bg-white font-[Roboto,sans-serif]">
      ...
      <div className="relative z-10 w-full max-w-[440px] px-10 pt-10 pb-8 mt-20 animate-[authCardAppear_0.6s_cubic-bezier(0.16,1,0.3,1)_both]">
        ...
        <p className="text-sm text-[rgba(51,51,51,1)] mb-7 max-w-[320px] mx-auto -translate-x-0 md:-translate-x-4 ">
          Sign in to your Hexa AI account
        </p>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-[1.15rem]">
          ...
          <div className="flex flex-col gap-[0.35rem]">
            <div className="flex justify-between items-center">
              <label htmlFor="login-password" className="text-[0.8rem] font-medium text-gray-700 tracking-wide">
                Password
              </label>
              <Link href="/forgot-password" className="text-xs text-sky-500 font-medium no-underline hover:text-sky-600 transition-colors">
                Forgot Password?
              </Link>
            </div>
        ...
        <p className="text-center text-[0.8rem] text-gray-500 mt-5">
          ...
          <Link href="/signup" className="text-sky-500 font-semibold no-underline hover:text-sky-600 hover:underline transition-colors">
            Sign Up
          </Link>
        </p>
      </div>
